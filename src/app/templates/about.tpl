<div class="about-container">
    ...
    <div class="content">
        ...
        <div class="icons_social">
            ...
            <a href='https://twitter.com/<%= Settings.projectTwitter %>' data-toggle="tooltip" data-placement="top" title="https://twitter.com/<%= Settings.projectTwitter %>" class='links twitter_icon'></span></a>
