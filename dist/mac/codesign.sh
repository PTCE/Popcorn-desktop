...
build="${dir}/../../build/releases/Popcorn/mac"
app="${build}/Popcorn.app"
identity="2Z88DW977Y"
...
echo "### create dmg"
dist/mac/yoursway-create-dmg/create-dmg --volname "Popcorn ${1}" --background ./dist/mac/background.png --window-size 480 540 --icon-size 128 --app-drop-link 240 370 --icon "Butter" 240 110 "${build}/Butter-${1}-Mac.dmg" "${build}"

dmg="${build}/Popcorn-${1}-Mac.dmg"
